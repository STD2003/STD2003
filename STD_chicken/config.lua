...
------------------------------------
Config.zone = {
	chicken = { coords = vector3(2301.24, 4943.15, 41.4), name = '<font face="athiti"> ฟาร์มไก่ </font>', color = 43, sprite = 89, scale = 0.8 } -- ตำแหน่ง   ชื่อ   สี   สัญลักษณ์  ขนาด บนแมพ
}
------------------------------------
--------- STD Item -------------
------------------------------------
Config.ItemCount = {1, 1}
Config.ItemName = "raw_egg" -- ไอเทมที่ดรอป 
...
--------- STD Text -------------
------------------------------------
Config.worktext = "กำลังเก็บไข่ไก่.. " ---- ตัวหนังสือตอน  เก็บ
...
Config.textpickup = "~w~กด ~g~E ~w~เพื่อเก็บไข่ไก่"  -- ตัวหนังสือ ตอนเก็บ

------------------------------------
------- STD Prop & Animal ------
------------------------------------
Config.animalname = 'a_c_hen' --โมเดลออฟเจ็ค
