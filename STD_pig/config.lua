...
------------------------------------
Config.zone = {
	pig = { coords = vector3(1452.03, 1066.83, 114.33), name = '<font face="athiti"> ฟาร์มหมู </font>', color = 50, sprite = 267, scale = 0.8 } -- ตำแหน่ง   ชื่อ   สี   สัญลักษณ์  ขนาด บนแมพ
}
------------------------------------
--------- STD Item -------------
------------------------------------
Config.ItemCount = {1, 1}
Config.ItemName = "raw_pig" -- ไอเทมที่ดรอป 
...
--------- STD Text -------------
------------------------------------
Config.worktext = "กำลังเก็บเนื้อหมู.. " ---- ตัวหนังสือตอน  เก็บ
...
Config.textpickup = "~w~กด ~g~E ~w~เพื่อเก็บเนื้อหมู"  -- ตัวหนังสือ ตอนเก็บ

------------------------------------
------- STD Prop & Animal ------
------------------------------------
Config.animalname = 'a_c_pig' --โมเดลออฟเจ็ค
